...
def return_arguments():
    ...
    parser.add_argument('--pretrained', default=True, help='Use weights of pretrained model')
    ...
    parser.add_argument('--device', default='cuda:0', help='choose cpu or cuda:0 device"' )
    parser.add_argument('--do_augmentation', default=True, help='do augmentation of images or not')
    ...
    parser.add_argument('--print_images', default=True,
                        help='print disparity and image generated from disparity on every iteration')
    parser.add_argument('--print_weights', default=False, help='print weights of every layer')
